...
<h1><a href="../../index.html" title="回到首页">Java性能优化[1]：基本类型 vs 引用类型</a></h1>
...
<a href="/2009/03/java-performance-tuning-1-two-types.md">2009/03/java-performance-tuning-1-two-types.html</a>
</div>
</div>
</body>
</html>
